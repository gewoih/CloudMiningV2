...
namespace CloudMining.Infrastructure.Migrations
{
    ...
    [Migration("20240520045331_User_TelegramFields_Added")]
    partial class User_TelegramFields_Added
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CloudMining.Domain.Models.Currencies.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e9a46756-82a4-414e-b0d3-180a0caf4772"),
                            Caption = "Рубль",
                            Code = 1,
                        ...
                        new
                        {
                            Id = new Guid("417e4b63-4176-40cf-8a5f-ac73934fc6f4"),
                            Caption = "Доллар",
                            Code = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("cc19d5de-a09a-4858-b7df-1963f4e37ece"),
                            Caption = "Bitcoin",
                            Code = 2,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("c8e12303-cc8f-4aeb-a04c-734b3b661213"),
                            Caption = "Etherium",
                            Code = 3,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("4c96f231-39d4-47ab-a441-dab6b00c8ae0"),
                            Caption = "Litecoin",
                            Code = 4,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("7bcb9a37-cc71-4a01-8548-c5f9aef1cc38"),
                            Caption = "Dogecoin",
                            Code = 5,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
